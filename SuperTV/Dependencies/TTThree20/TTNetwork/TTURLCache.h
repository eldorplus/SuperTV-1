...
#define kDirCommonCacheImage @"Imgs"               //  图片缓存文件夹
#define kDirCommonCacheDocument @"Docs"

#define     kSeqmentTotalLength     @"totalLength"
#define     kSeqmentCurrentLength   @"currentLength"
