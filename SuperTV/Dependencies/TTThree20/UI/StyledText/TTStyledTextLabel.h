...
@class TTStyledElement, TTStyledBoxFrame;
@protocol TTStyledTextLabelDelegate;
...
@interface TTStyledTextLabel : UIView <TTStyledTextDelegate> {
  ...
  NSMutableArray* _accessibilityElements;
	...
	id<TTStyledTextLabelDelegate> _delegate;
	BOOL _longPress;
	
	CGFloat	_lineMarge;
}

@property(nonatomic) CGFloat lineMarge;
...
@protocol TTStyledTextLabelDelegate
@required
- (void)tstyledTextLabel:(TTStyledTextLabel*)style didSelectedText:(NSString *)strText Type:(TTStyledLinkType)linkType;
@optional
- (void)tstyledTextLabelLongPress:(TTStyledTextLabel*)style;
@end
